...
void TPC_Channel_QA(){
  ...
  for (int q = 0; q < 24; q++){
    ...
    string runNumber = "pedestal-00010619";
    
    string fileName = "/sphenix/u/jamesj3j3/workfest_Charles_mistake/sPHENIXProjects/run-10305/TPC_ebdc"+sectorNumber+"_"+runNumber+"-0000.prdf_TPCRawDataTree.root";
