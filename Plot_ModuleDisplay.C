...
void Plot_ModuleDisplay(){
  ...
  TH2F * dm2 = new TH2F("dm2","TPC map",24, -.5, 23.5, 3, .5,3.5);
  liveTntuple->Draw("module_id:sec_id>>dm2","","colz");

  TH2F * tot = new TH2F("tot"," TPC Tot Map", 24, -.5, 23.5, 3, .5, 3.5);
  totTntuple->Draw("module_id:sec_id>>tot","","colz");
  //h3->Draw("colz");
